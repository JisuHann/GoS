...
import rvt.mvt.config_mask as default_mvt_cfg
import rvt.models.rvt_agent_mask as rvt_agent
...
def load_agent(
    ...
    if not (peract_official):
        ...
        agent = rvt_agent.RVTAgent(
            ...
            log_dir=f"{eval_log_dir}/test_run/",
            **exp_cfg.peract,
            **exp_cfg.rvt,
        )
...
def eval(
    ...
    for task_id in range(num_tasks):
        ...
        if save_video:
            video_image_folder = "/home/guest/Desktop/RVT/mask_result"
            record_fps = 25
