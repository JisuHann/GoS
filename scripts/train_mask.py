...
import rvt.models.rvt_agent_mask as rvt_agent_mask
import rvt.utils.ddp_utils as ddp_utils
import rvt.mvt.config_mask as mvt_cfg_mod
import sys
sys.path.append('/home/guest/Desktop/RVT')
from rvt.mvt.mvt_mask import MVT
from rvt.models.rvt_agent_mask import print_eval_log, print_loss_log
...
def experiment(rank, cmd_args, devices, port):
    ...
    # wandb_mode = 'disabled'
    wandb_mode = 'online'
    name = f'6x6mask/{exp_cfg.bs}/{NUM_TRAIN}/feat{mvt_cfg.attn_dim}'
    ...
    while True:
        ...
        eval(agent, eval_dataset, int(TRAINING_ITERATIONS), rank, epoch=i)
        if rank == 0:
